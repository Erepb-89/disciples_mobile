...
from PyQt5.QtGui import QPixmap, QMovie, QStandardItem, QStandardItemModel, QCursor
...
class FightWindow(QMainWindow):
    ...
    def attack_enemy_by_slot(self, slot, side):

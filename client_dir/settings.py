...
ALCHEMIST_LIST = ['Увеличение урона', 'Увеличение урона/Исцеление',
                  'Дополнительная атака']
PARALYZE_LIST = ['Паралич', 'Окаменение']
DOT_LIST = ['Яд', 'Ожог', 'Обморожение', 'Снижение инициативы',
            'Снижение урона', 'Увеличение урона']
PARALYZE_UNIT_LIST = ['Баньши', 'Привидение', 'Призрак', 'Тень',
                      'Тёмный эльф-гаст']

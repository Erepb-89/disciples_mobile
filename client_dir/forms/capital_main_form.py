...
class Ui_CapitalWindow(object):
    def setupUi(self, CapitalWindow):
        ...
        self.buildingMage1 = QtWidgets.QLabel(self.centralwidget)
        self.buildingMage1.setGeometry(QtCore.QRect(200, 0, 960, 900))
        self.buildingMage1.setFrameShape(QtWidgets.QFrame.Panel)
        self.buildingMage1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.buildingMage1.setLineWidth(0)
        self.buildingMage1.setMidLineWidth(0)
        self.buildingMage1.setText("")
        self.buildingMage1.setScaledContents(True)
        self.buildingMage1.setAlignment(QtCore.Qt.AlignCenter)
        self.buildingMage1.setObjectName("buildingMage1")

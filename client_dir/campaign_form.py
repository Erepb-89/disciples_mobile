...
class Ui_CampaignWindow(object):
    def setupUi(self, CampaignWindow):
        ...
        self.armySlot = QtWidgets.QLabel(self.centralwidget)
        self.armySlot.setGeometry(QtCore.QRect(60, 60, 141, 171))
        self.armySlot.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.armySlot.setFrameShadow(QtWidgets.QFrame.Raised)
        self.armySlot.setLineWidth(0)
        self.armySlot.setMidLineWidth(0)
        self.armySlot.setScaledContents(True)
        self.armySlot.setObjectName("armySlot")
        self.pushButtonArmy = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonArmy.setGeometry(QtCore.QRect(60, 60, 141, 171))
        self.pushButtonArmy.setText("")
        self.pushButtonArmy.setFlat(True)
        self.pushButtonArmy.setObjectName("pushButtonArmy")
        self.pushButtonBoss = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonBoss.setGeometry(QtCore.QRect(1260, 60, 224, 260))
        self.pushButtonBoss.setText("")
        self.pushButtonBoss.setFlat(True)
        self.pushButtonBoss.setObjectName("pushButtonBoss")
        self.bossSlot = QtWidgets.QLabel(self.centralwidget)
        self.bossSlot.setGeometry(QtCore.QRect(1260, 60, 224, 260))
        self.bossSlot.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.bossSlot.setFrameShadow(QtWidgets.QFrame.Raised)
        self.bossSlot.setLineWidth(0)
        self.bossSlot.setMidLineWidth(0)
        self.bossSlot.setScaledContents(True)
        self.bossSlot.setObjectName("bossSlot")
        self.pushButtonCapital = QtWidgets.QPushButton(self.centralwidget)
        self.pushButtonCapital.setGeometry(QtCore.QRect(0, 0, 90, 28))
        self.pushButtonCapital.setObjectName("pushButtonCapital")
        self.pushButtonCapital.setText("Столица")
        ...
        self.line_14.raise_()
        self.line_15.raise_()
        self.armySlot.raise_()
        self.pushButtonArmy.raise_()
        self.bossSlot.raise_()
        self.pushButtonBoss.raise_()

...
magic_guild = Building('Башня магии', '', 300, '', [480, 287, 118, 114], MAGIC_DESC)
temple = Building('Храм', '', 150, '', [480, 555, 118, 114], TWMPLE_DESC)
...
FACTIONS = {
    EM: {
        ...
        'fighter': {
            ...
            2: Building('Конюшня Империи', 'Имперский рыцарь', '', 500, [320, 259, 118, 114], COMMON_DESC),
            3: Building('Алтарь', 'Паладин', 1500, '', [424, 499, 118, 114], COMMON_DESC),
            4: Building('Священная Статуя', 'Священный мститель', 3000, '', [296, 745, 118, 114], COMMON_DESC),
            5: Building('Часовня', 'Защитник Веры', 3000, '', [554, 745, 118, 114], COMMON_DESC),
            6: Building('Фонтан Жизни', 'Ангел', 1500, '', [236, 499, 118, 114], COMMON_DESC),
            7: Building('Подземелье', 'Охотник на ведьм', 200, '', [646, 33, 118, 114], COMMON_DESC),
            8: Building('Камера пыток', 'Инквизитор', 500, '', [646, 260, 118, 114], COMMON_DESC),
            9: Building('Магистрат', 'Великий инквизитор', 1500, '', [646, 500, 118, 114], COMMON_DESC),
        },
        'archer': {
            0: Building('', 'Лучник', 0, '', [440, 32, 118, 114], ''),
            1: Building('Стрельбище', 'Стрелок', 200, '', [440, 32, 118, 114], COMMON_DESC),
            2: Building('Гильдия Империи', 'Имперский ассасин', 'Стрельбище', 500, [441, 259, 118, 114], COMMON_DESC),
        },
        'mage': {
    ...
    UH: {
        ...
        'mage': {
            ...
            9: Building('Обитель душ', 'Сущий', 2250, 'Часовня проклятых', [697, 504, 118, 116], COMMON_DESC),
        },
        'support': {
        ...
        'special': {
            0: Building('', '', 0, '', [], ''),
            1: Building('Логово оборотней', 'Оборотень', 750, 'Пещера', [], SPECIAL_DESC),
        }
    },
    LD: {
        'others': {
    ...
    MC: {
        ...
        'fighter': {
            ...
            5: Building('Рунный Зал', 'Мастер рун', 3000, 'Храм Предков', [424, 744, 118, 114], COMMON_DESC),
        ...
        'mage': {
            ...
            2: Building('Сад Мудрости', 'Друид', 500, 'Хижина', [235, 307, 118, 114], COMMON_DESC),
            3: Building('Древо Старейшин', 'Архидруид', 1500, 'Сад Мудрости', [234, 568, 118, 114], COMMON_DESC),
        ...
        'support': {
            ...
            5: Building('Ледяные пещеры', 'Сын Имира', 2250, 'Снежные горы', [630, 505, 120, 114], COMMON_DESC),
        },
        'special': {
            0: Building('', '', 0, '', [], ''),
